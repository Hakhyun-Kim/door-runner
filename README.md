...
> 📌 **이 게임의 "두 문 달리기"는 NAN 2026 제출작 [백층 던전](https://hakhyun-kim.github.io/dungeon100/)의 보물상자 미니게임으로 통합되었습니다.** 여기 저장소는 원작이며, 해커톤 제출작은 두 게임이 합쳐진 백층 던전입니다.
...
## 해커톤 제출작 — 백층 던전 (Dungeon 100)

이 게임의 "두 문" 메커닉을 미니게임으로 **통합**한 3D 로그라이크. 마찬가지로 AI(Claude Code)와 함께 만들었으며, **NAN 2026 사전과제 제출작**입니다.
